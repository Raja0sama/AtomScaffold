...
import LoginWithPhoneNumber from 'app/utils/Firebase/authentication';
...
const Login = ({params}) => {
  ...
  const loginwithPhoneNumber = async (number) => {
      const confirmation = await LoginWithPhoneNumber(number)
